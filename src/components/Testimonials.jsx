...
const Testimonials = () => {
  ...
  >
    <motion.span
      ...
      className="text-sm font-semibold tracking-wider text-orange-600 uppercase bg-orange-100 px-4 py-2 rounded-full cursor-pointer"
    >
      Testimonials
    </motion.span>
  </motion.div>
          ...
          <div className="text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Be the next athlete to achieve their goals with our proven
                programs.
              </p>
